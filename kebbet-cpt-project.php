...
function bulk_post_updated_messages( $bulk_messages, $bulk_counts ) {
	...
	$bulk_messages[ POSTTYPE ] = array(
		...
		'updated'   => _n( '%s post updated.', '%s posts updated.', $bulk_counts['updated'], 'kebbet-cpt-project' ),
		/* translators: %s: singular of posts, %$s: plural of posts.  */
		'locked'    => _n( '%s post not updated, somebody is editing it.', '%s posts not updated, somebody is editing them.', $bulk_counts['locked'], 'kebbet-cpt-project' ),
		/* translators: %s: singular of posts, %$s: plural of posts.  */
		'deleted'   => _n( '%s post permanently deleted.', '%s posts permanently deleted.', $bulk_counts['deleted'], 'kebbet-cpt-project' ),
		/* translators: %s: singular of posts, %$s: plural of posts.  */
		'trashed'   => _n( '%s post moved to the Trash.', '%s posts moved to the Trash.', $bulk_counts['trashed'], 'kebbet-cpt-project' ),
		/* translators: %s: singular of posts, %$s: plural of posts.  */
		'untrashed' => _n( '%s post restored from the Trash.', '%s posts restored from the Trash.', $bulk_counts['untrashed'], 'kebbet-cpt-project' ),
	);
